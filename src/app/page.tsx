     ...
     <Parallax pages={6} className=' hideScrollbar ' >
        ...
        >
          ...
          <h1 className=' text-3xl p-5 font-serif'>Our Vision</h1>
            <p className=' font-sans'>Pedestal Education is an educational venture to tap into the human potential of young people of Sikkim and to inculcate a competitive spirit among students and aspirants.
             Civil services and government service has always captured the 
            interest of the youth. In Sikkim, UPSC civil service exam has garnered a sense of mysticism with very few of Sikkimese clearing such exams and even fewer represented in governance.
